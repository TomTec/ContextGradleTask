...
/**
 * Original class taken from org.jetbrains.plugins.gradle.service.task.GradleRunTaskDialog
 * @author Jetbrains team
 */
public class RunGradleTaskDialog extends DialogWrapper {
    ...
    public RunGradleTaskDialog(@NotNull Project project) {
        this(project, null);
    }

    public RunGradleTaskDialog(@NotNull Project project, @Nullable Collection<String> history) {
        super(project, true);
        myProject = project;
        myHistory = history;
